...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Creative Tim</a> x <a href="https://muhammaddzakiardiansyah.github.io/codeauthentic/" class="font-weight-bold" target="_blank">Muhammad Dzaki</a>
                for a better web.
              </div>
            </div>
          </div>
  ...
  <?php else : ?>
    ...
    <div class="d-flex justify-content-center">
      <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script><lottie-player src="https://lottie.host/683bdef2-2a68-4a73-bfa7-3567c431ab3e/Heh0ywK17K.json" background="##ced4da" speed="1" style="width: 200px; height: 200px" loop autoplay direction="1" mode="normal"></lottie-player>
    </div>
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                  ...
                  <tbody>
                    <?php foreach ($studentPresence as $presence) : ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold"> <?= date("d F Y", strtotime($presence["date_attendance"])); ?> </span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold"> <?= $presence["student_attendance"] ?> </span>
                        </td>
